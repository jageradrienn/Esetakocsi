...
import { sep, resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setHeaders, sendRedirect, proxyRequest, createError, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/h3/dist/index.mjs';
import p$1, { stdin, stdout } from 'node:process';
import f from 'node:readline';
import * as tty from 'node:tty';
import { WriteStream } from 'node:tty';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/unhead/dist/server.mjs';
import { isVNode, toValue, isRef } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/vue/index.mjs';
import { walkResolver } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/unhead/dist/utils.mjs';
...
import defu$1, { defuFn } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/defu/dist/defu.mjs';
...
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/node-mock-http/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import { formatWithOptions } from 'node:util';
import { ErrorParser } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/source-map/source-map.js';
...
import { digest } from 'file://C:/work/Kicsikocsik/Esetakocsik/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
...
const r$1=Object.create(null),i=e=>globalThis.process?.env||globalThis._importMeta_.env||globalThis.Deno?.env.toObject()||globalThis.__env__||(e?r$1:globalThis),s$1=new Proxy(r$1,{get(e,o){return i()[o]??r$1[o]},has(e,o){const E=i();return o in E||o in r$1},set(e,o,E){const b=i(true);return b[o]=E,true},deleteProperty(e,o){if(!o)return  false;const E=i(true);return delete E[o],true},ownKeys(){const e=i(true);return Object.keys(e)}}),t=typeof process<"u"&&process.env&&"development"||"",B$1=[["APPVEYOR"],["AWS_AMPLIFY","AWS_APP_ID",{ci:true}],["AZURE_PIPELINES","SYSTEM_TEAMFOUNDATIONCOLLECTIONURI"],["AZURE_STATIC","INPUT_AZURE_STATIC_WEB_APPS_API_TOKEN"],["APPCIRCLE","AC_APPCIRCLE"],["BAMBOO","bamboo_planKey"],["BITBUCKET","BITBUCKET_COMMIT"],["BITRISE","BITRISE_IO"],["BUDDY","BUDDY_WORKSPACE_ID"],["BUILDKITE"],["CIRCLE","CIRCLECI"],["CIRRUS","CIRRUS_CI"],["CLOUDFLARE_PAGES","CF_PAGES",{ci:true}],["CODEBUILD","CODEBUILD_BUILD_ARN"],["CODEFRESH","CF_BUILD_ID"],["DRONE"],["DRONE","DRONE_BUILD_EVENT"],["DSARI"],["GITHUB_ACTIONS"],["GITLAB","GITLAB_CI"],["GITLAB","CI_MERGE_REQUEST_ID"],["GOCD","GO_PIPELINE_LABEL"],["LAYERCI"],["HUDSON","HUDSON_URL"],["JENKINS","JENKINS_URL"],["MAGNUM"],["NETLIFY"],["NETLIFY","NETLIFY_LOCAL",{ci:false}],["NEVERCODE"],["RENDER"],["SAIL","SAILCI"],["SEMAPHORE"],["SCREWDRIVER"],["SHIPPABLE"],["SOLANO","TDDIUM"],["STRIDER"],["TEAMCITY","TEAMCITY_VERSION"],["TRAVIS"],["VERCEL","NOW_BUILDER"],["VERCEL","VERCEL",{ci:false}],["VERCEL","VERCEL_ENV",{ci:false}],["APPCENTER","APPCENTER_BUILD_ID"],["CODESANDBOX","CODESANDBOX_SSE",{ci:false}],["STACKBLITZ"],["STORMKIT"],["CLEAVR"],["ZEABUR"],["CODESPHERE","CODESPHERE_APP_ID",{ci:true}],["RAILWAY","RAILWAY_PROJECT_ID"],["RAILWAY","RAILWAY_SERVICE_ID"],["DENO-DEPLOY","DENO_DEPLOYMENT_ID"],["FIREBASE_APP_HOSTING","FIREBASE_APP_HOSTING",{ci:true}]];function p(){if(globalThis.process?.env)for(const e of B$1){const o=e[1]||e[0];if(globalThis.process?.env[o])return {name:e[0].toLowerCase(),...e[2]}}return globalThis.process?.env?.SHELL==="/bin/jsh"&&globalThis.process?.versions?.webcontainer?{name:"stackblitz",ci:false}:{name:"",ci:false}}const l=p();l.name;function n(e){return e?e!=="false":false}const I$1=globalThis.process?.platform||"",T$1=n(s$1.CI)||l.ci!==false,R$2=n(globalThis.process?.stdout&&globalThis.process?.stdout.isTTY),U=n(s$1.DEBUG),A$2=t==="test"||n(s$1.TEST);n(s$1.MINIMAL)||T$1||A$2||!R$2;const _$1=/^win/i.test(I$1);!n(s$1.NO_COLOR)&&(n(s$1.FORCE_COLOR)||(R$2||_$1)&&s$1.TERM!=="dumb"||T$1);const C=(globalThis.process?.versions?.node||"").replace(/^v/,"")||null;Number(C?.split(".")[0])||null;const y$2=globalThis.process||Object.create(null),c$1={versions:{}};new Proxy(y$2,{get(e,o){if(o==="env")return s$1;if(o in e)return e[o];if(o in c$1)return c$1[o]}});const L$1=globalThis.process?.release?.name==="node",a$1=!!globalThis.Bun||!!globalThis.process?.versions?.bun,D=!!globalThis.Deno,O$1=!!globalThis.fastly,S$2=!!globalThis.Netlify,N$1=!!globalThis.EdgeRuntime,P$1=globalThis.navigator?.userAgent==="Cloudflare-Workers",F=[[S$2,"netlify"],[N$1,"edge-light"],[P$1,"workerd"],[O$1,"fastly"],[D,"deno"],[a$1,"bun"],[L$1,"node"]];function G$2(){const e=F.find(o=>o[0]);if(e)return {name:e[1]}}const u$1=G$2();u$1?.name||"";
...
function createConsola(options = {}) {
  ...
  const consola2 = createConsola$1({
    ...
    prompt: (...args) => Promise.resolve().then(function () { return prompt$1; }).then((m) => m.prompt(...args)),
    reporters: options.reporters || [
      options.fancy ?? !(T$1 || A$2) ? new FancyReporter() : new BasicReporter()
    ],
    ...options
  });
  return consola2;
...
const _I9IVtRTu6eznnG80bquredxBYM5rkSuvbL6epfBOGk = (function(nitro) {
...
const _NxQpx0D8BYE60GNnoSrkqjkomIA8lspq9a7BawGYZ0 = (nitroApp) => {
...
const plugins = [
  _I9IVtRTu6eznnG80bquredxBYM5rkSuvbL6epfBOGk,
_NxQpx0D8BYE60GNnoSrkqjkomIA8lspq9a7BawGYZ0
];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/work/Kicsikocsik/Esetakocsik","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/work/Kicsikocsik/Esetakocsik/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/work/Kicsikocsik/Esetakocsik/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/work/Kicsikocsik/Esetakocsik/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/work/Kicsikocsik/Esetakocsik/.data/kv"}));
...
const _CImlSB = lazyEventHandler(() => {
...
const _lazy_QNWFD1 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_QNWFD1, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _CImlSB, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_QNWFD1, lazy: true, middleware: false, method: undefined }
];
...
const prompt$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  kCancel: kCancel,
  prompt: prompt
});
